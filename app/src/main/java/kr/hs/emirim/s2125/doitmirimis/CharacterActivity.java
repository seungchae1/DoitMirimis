...
public class CharacterActivity extends AppCompatActivity {
    ...
    public static int imgId[]={R.drawable.img, R.drawable.img2, R.drawable.img3, R.drawable.img4, R.drawable.img5, R.drawable.img6, R.drawable.img6,R.drawable.img6, R.drawable.img6,
